                    ...
                    <form method="post" action="{{ route('update.password') }}" >
                        ...
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-2 col-form-label"> Old Password</label>
                                <div class="col-sm-10">
                                 <input name="oldpassword" class="form-control" type="password" id="oldpassword" value="">
                                 <input class="checkbox-wrapper-mail" type="checkbox" onclick="myFunction()">Show Password
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-2 col-form-label"> New Password</label>
                                <div class="col-sm-10">
                                 <input name="newpassword" class="form-control" type="password" id="newpassword" value="">
                                 <input class="checkbox-wrapper-mail" type="checkbox" onclick="myFunction2()">Show Password
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-2 col-form-label"> Confirm New Password</label>
                                <div class="col-sm-10">
                                 ...
                                 <input class="checkbox-wrapper-mail" type="checkbox" onclick="myFunction3()">Show Password
                            </div>
                        </div>
