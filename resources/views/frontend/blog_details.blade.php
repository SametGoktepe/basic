            ...
            <div class="col-lg-8">
                <div class="standard__blog__post">
                    <div class="standard__blog__thumb">
                        <img src="{{ asset($blogs->blog_image) }}" style="width:850px; height:430px; " alt="">
                    </div>
                    ...
                    <div class="blog__details__bottom">
                        ...
                        <ul class="blog__details__social">
                            ...
                            <li class="social-icons">
                                <a href="https://github.com/SametGoktepe"><i class="fab fa-github"></i></a>
                                <a href="https://twitter.com/samet74goktepe"><i class="fab fa-twitter-square"></i></a>
                                <a href="https://linkedin.com/in/samet-göktepe-419932215/"><i class="fab fa-linkedin"></i></a>
                                <a href="https://www.instagram.com/samet.goktepe/?hl=tr""><i class="fab fa-instagram"></i></a>
                            </li>
                        </ul>
                    </div>
